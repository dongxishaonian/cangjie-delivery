      ...
      position(e) {
        ...
        if (this.drag_point) {
          ...
          const e = this.ele_selected.parentElement.classList[2].slice(9),
            ...
            d = this.ele_selected.parentElement.classList[3], a = this.ele_selected.parentElement.classList[4];
      ...
      updateConnectionNodes(e) {
        ...
        Object.keys(f).map((function (t, n) {
          if (null === f[t].querySelector(".point")) {
            var g = i.querySelector("#" + e), m = f[t].classList[1].replace("node_in_", ""),
        ...
        Object.keys(g).map((function (t, n) {
          if (null === g[t].querySelector(".point")) {
            var h = i.querySelector("#" + e), f = g[t].classList[2].replace("node_out_", ""),
